...
describe('[Challenge] Side entrance', function () {
    ...
    it('Execution', async function () {
        ...
        const AttackSideEnt = await (await ethers.getContractFactory('AttackSideEntrance', player)).deploy(ETHER_IN_POOL,pool.address,player.address);
        await AttackSideEnt.attack();
    });
...
describe("[Test] Side entrance", function () {
  let deployer, player;
  let pool;
